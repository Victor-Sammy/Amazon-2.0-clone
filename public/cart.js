    ...
    cartItems.forEach((item)=>{
        itemsHTML += `
            <div class="cart-item flex items-center pb-4 border-b border-gray-100">
                <div class="cart-item-image w-40 h-40 bg-white p-3 rounded-lg">
                ...
                <div class="cart-item-counter w-40 flex items-center">
                ...
                <div data-id="${item.id}" class="cart-item-delete font-bold w-10 text-gray-300 cursor-pointer hover:text-gray-400">
